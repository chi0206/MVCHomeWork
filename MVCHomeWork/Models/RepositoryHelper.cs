namespace MVCHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料對照表Repository Get客戶資料對照表Repository()
		{
			var repository = new 客戶資料對照表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料對照表Repository Get客戶資料對照表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料對照表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
